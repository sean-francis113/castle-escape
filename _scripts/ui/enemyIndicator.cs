...
public class enemyIndicator : MonoBehaviour {
    ...
    public arrowFacing iconFace = arrowFacing.Up;
    ...
    void Start () {
        ...
        if(iconFace == arrowFacing.Up){
            
            iconAngle = 0f;
            
        } else if(iconFace == arrowFacing.Right){
            
            iconAngle = -90f;
            
        } else if(iconFace == arrowFacing.Down){
            
            iconAngle = -180f;
            
        } else if(iconFace == arrowFacing.Left){
    ...
    void OnGUI () {
        ...
        if (!visible) {
            ...
            float angle = Mathf.Atan2(pdir.x, pdir.y) * Mathf.Rad2Deg + iconAngle;
