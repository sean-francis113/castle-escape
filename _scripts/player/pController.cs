 ...
 * Updated: 11/26/2017
 * Author: Sean Francis
 * Description: Player Controller Controlling Motion,
                Checking Grounding and Inputting Attacks.
 ************************************************
 */
...
/// <summary>
/// Player Controller for Castle/Princess Escape.
/// Also defines movestate enums
/// </summary>
...
public class pController : MonoBehaviour {
    ...
    [Header("Health Flash Values")]
    public float healthFlashDelay;
    ...
    private float healthFlashTimer = 0.0f;
    ...
    public void checkCheat()
    {
        ...
        if(Input.GetKey(KeyCode.LeftControl) && Input.GetKey(KeyCode.LeftAlt) && Input.GetKey(KeyCode.B))
        {
            ...
            player.floorsCleared = player.maxClear - 1;
    ...
    void heal(int healing)
    {
        ...
        healthFlashTimer = healthFlashDelay;
